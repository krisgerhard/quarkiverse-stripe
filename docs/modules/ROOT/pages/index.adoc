...
If you want to use this extension, you need to add the `io.quarkiverse.stripe:quarkus-stripe` extension first to your build file.
...
include::includes/quarkus-stripe.adoc[leveloffset=+1, opts=optional]
